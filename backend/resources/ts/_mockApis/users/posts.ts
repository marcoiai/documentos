...
// types
import type { Post } from '@db/apps/users/types'

// assets
import image1 from '@images/profile/img-profile1.png'
import image2 from '@images/profile/img-profile2.png'
import image4 from '@images/profile/img-profile4.png'
...
mock.onPost('/api/replies/list/like').reply(config => {
  try {
    ...
    if (replayIndex !== undefined && comment && comment.data && comment.data.replies) {
