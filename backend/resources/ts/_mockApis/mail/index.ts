...
import attach1 from '@images/profile/img-gal-1.png'
import attach2 from '@images/profile/img-gal-2.png'
import attach3 from '@images/profile/img-gal-3.png'

// types
import type { MailProps } from '@db/apps/mail/types'
...
mock.onPost('/api/mails/setRead').reply(config => {
  try {
    ...
    const mailIndex = mails.findIndex(index => index.id === id)
