  ...
  <VRow>
          ...
          >
            ...
            >
              <div class="d-flex justify-space-between">
                <h5 class="text-h6 mb-0 text-lightText">
                  {{ skill.title }}
                </h5>
                <div class="flex-1-1">
    ...
    >
      ...
      >
        ...
        <VDivider />
        <VCardText>
          <VRow class="py-2 mx-0 details-content">
            <VCol
      ...
      >
        ...
        >
          ...
          <VDivider />
          <VCardText>
            <VRow class="py-2 mx-0 education-content">
              <VCol
                v-for="(edu, i) in edus"
                :key="i"
                sm="6"
        ...
        >
          ...
          >
            ...
            <VDivider />
            <VCardText class="employment-content">
              <VRow
                v-for="(emp, i) in emps"
                :key="i"
                class="pt-3"
              >
                <VCol md="4">
                  <h4 class="text-h6 text-lightText mb-0">
                    {{ emp.year }}
                  </h4>
