...
import completed from '@images/e-commerce/completed.png'
</script>

<template>
  <VCard>
    <VCardItem class="py-8 text-center">
      <img
        :src="completed"
        alt="Thankyou"
        class="my-6 thank-you-image"
      >
      <h1 class="text-md-h1 text-h3">
