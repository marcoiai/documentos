...
const chartOptions1 = computed(() => {
  return {
    ...
    colors: ['rgba(var(--v-theme-darkText), var(--v-high-opacity))', 'rgba(var(--v-theme-primary), var(--v-high-opacity))', 'rgba(var(--v-theme-lightprimary), var(--v-high-opacity))'],
    stroke: {
      curve: 'smooth',
      width: 6,
      colors: ['transparent'],
  ...
  >
    ...
    >
      <div class="pt-5 d-flex align-center px-4">
        ...
        <h5 class="text-primary text-h5 ms-auto mb-0">
          -128
        </h5>
      </div>
      <VueApexCharts
